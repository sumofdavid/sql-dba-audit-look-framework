...
-- ##########################################################
DECLARE @version nvarchar(100) = N'01.01.00',
...
IF OBJECT_ID('audit.AuditStore','U') IS NULL
    BEGIN
...
IF OBJECT_ID('dbo.f_QuoteString','FN') IS NOT NULL
    BEGIN
        DROP PROCEDURE dbo.f_QuoteString;
    END
GO
PRINT 'creating dbo.f_QuoteString function';
GO
